...
<head>
  ...
  <style>
    :root{--bg:#0b1226;--card:#0f1833;--muted:#9bb0e4;--text:#e8eeff;--u:#60a5fa;--d:#f472b6;--accent:#3b82f6;--ok:#22c55e;--row:#0c152d;--row2:#0d1731}
...
<body>
  <div class="wrap">
    ...
    <div class="cards">
      <div class="card"><h3>Download (Now)</h3><div class="big"><span id="net_down_val" data-val="0">0.00</span> <span class="muted">Mbps</span></div><div class="muted">Sum of all ONUs</div></div>
      <div class="card"><h3>Upload (Now)</h3><div class="big"><span id="net_up_val" data-val="0">0.00</span> <span class="muted">Mbps</span></div><div class="muted">Sum of all ONUs</div></div>
      <div class="card"><h3>Total (Now)</h3><div class="big"><span id="net_total_val" data-val="0">0.00</span> <span class="muted">Mbps</span></div><div class="muted">Updated <span id="net_dt">—</span>s ago · <span id="net_when">—</span></div></div>
    </div>

    <div class="cards">
      <div class="card"><h3>Peak (24h)</h3><div class="big" id="pk_24h">— Mbps</div><div class="muted" id="pk_24h_t">—</div></div>
      <div class="card"><h3>Peak (7 days)</h3><div class="big" id="pk_7d">— Mbps</div><div class="muted" id="pk_7d_t">—</div></div>
      <div class="card"><h3>Peak (30 days)</h3><div class="big" id="pk_30d">— Mbps</div><div class="muted" id="pk_30d_t">—</div></div>
    </div>

    <div class="panel">
      <div class="controls">
        <div class="ctrl"><label class="muted" for="chart_date">Date</label><input id="chart_date" type="date" class="btn" style="padding:6px 8px"></div>
        <div class="ctrl"><label class="muted" for="chart_tf">Timeframe</label>
  ...
  <script>window.API_BASE='./api/';</script>
  <script src="./js/helpers.js?v=2025-08-17d"></script>
  <script src="./js/chart.js?v=2025-08-17d"></script>
  <script src="./js/table.js?v=2025-08-17d"></script>
</body>
</html>
