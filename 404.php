...
<?php include('header.php'); ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                        <div class="error-img text-center mb-40">
                            <img src="assets/imgs/images/404.webp" alt="">
                        </div>
 ...
 <?php include('footer.php'); ?>
   ...
   <script src="assets/js/jquery.flipster.min.js" defer></script>
...
<!-- Mirrored from www.devsnews.com/template/netfix-prev/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Dec 2024 09:15:22 GMT -->
</html>