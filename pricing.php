...
<?php include('header.php'); ?>
        ...
        <main>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-9">
                                <div class="pricing-item mb-30">
                                    ...
                                    <div class="pricing-content">
                                        <ul class="pricing-list">
                                            <li><img src="assets/imgs/icons/check.png" alt=""> 20 Devices Allowed</li>
                                            <li><img src="assets/imgs/icons/check.png" alt=""> Phone, Computer & TV</li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-9">
                                <div class="pricing-item mb-30">
                                    ...
                                    <div class="pricing-content">
                                        <ul class="pricing-list">
                                            <li><img src="assets/imgs/icons/check.png" alt=""> Unlimited Devices Allowed</li>
                                            <li><img src="assets/imgs/icons/check.png" alt=""> Any Devices</li>
                                            <li><img src="assets/imgs/icons/check.png" alt=""> Fixed IP</li>
                                        </ul>
                                        <div class="price-wrap">
                                            <span>Start From</span>
            ...
            <!-- subscribe-two-area -->
            <section class="subscribe-two-area subscribe-two-bg" data-background="assets/imgs/bg/subscribe_bg02.jpg">
                <div class="container">
...
<!-- Mirrored from www.devsnews.com/template/netfix-prev/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Dec 2024 09:15:09 GMT -->
</html>
