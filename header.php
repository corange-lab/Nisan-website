...
<div class="menu-wrap">
<nav class="menu-nav">
<div class="logo"><a href="/index"><img alt="logo" src="assets/imgs/logo/logo.webp" loading="eager" /></a></div>
                        ...
                        <div class="mobile-menu">
                            <nav class="menu-box">
                                ...
                                <div class="social-links">
                                    <ul class="clearfix">
                                        <li><a href="https://www.facebook.com/nisaninternet"><span class="fab fa-facebook-f"></span></a></li>
                                        <li><a href="https://www.instagram.com/nisaninternet"><span class="fab fa-instagram"></span></a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
